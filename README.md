...
> ISECMobile das demais centrais). **Ainda não foi testado contra
> hardware real** — toda a lógica vem de engenharia reversa do app
> oficial e de um fluxo de terceiros usado como referência. Ver a seção
